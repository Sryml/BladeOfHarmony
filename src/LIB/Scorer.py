...
wPoisonLabel.SetScale(GET_SCALE)
...
wLevelUpLabel.SetScale(GET_SCALE)
...
wCurrentLevelLabel.SetScale(GET_SCALE)
wOffset = -4
if Language.Current == "Russian":
    wOffset = -2
...
wDangerLabel.SetScale(GET_SCALE)
...
wEnergyMaxLabel.SetScale(GET_SCALE)
...
wNewObjectText.SetScale(GET_SCALE)
